...
var _user$project$Model_NodeData$propertyTypeToValue = function (propertyType) {
	var _p0 = propertyType;
	switch (_p0.ctor) {
		case 'RawText':
			return 'text';
		case 'HtmlText':
...
var _user$project$Model_NodeData$NodeData = F5(
	function (a, b, c, d, e) {
		return {propName: a, selector: b, propType: c, attributeName: d, isArray: e};
	});
var _user$project$Model_NodeData$Object = {ctor: 'Object'};
var _user$project$Model_NodeData$AttributeValue = {ctor: 'AttributeValue'};
var _user$project$Model_NodeData$HtmlText = {ctor: 'HtmlText'};
var _user$project$Model_NodeData$RawText = {ctor: 'RawText'};
var _user$project$Model_NodeData$propertyTypeOptions = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: _user$project$Model_NodeData$RawText, _1: 'Simple Text'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _user$project$Model_NodeData$HtmlText, _1: 'HTML text'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _user$project$Model_NodeData$AttributeValue, _1: 'Attribute Value'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _user$project$Model_NodeData$Object, _1: 'Object'},
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Model_NodeData$propertyTypeToText = function (propertyType) {
	var result = _elm_lang$core$List$head(
		A2(
			...
			_user$project$Model_NodeData$propertyTypeOptions));
	var _p1 = result;
	if (_p1.ctor === 'Nothing') {
		return 'error';
	} else {
...
var _user$project$Model_NodeData$valueToPropertyType = function (value) {
	return _elm_lang$core$List$head(
		A2(
			...
			A2(
				...
				function (n) {
					return _elm_lang$core$Native_Utils.eq(
						_user$project$Model_NodeData$propertyTypeToValue(
							_elm_lang$core$Tuple$first(n)),
						value);
				},
				_user$project$Model_NodeData$propertyTypeOptions)));
};
var _user$project$Model_NodeData$createDefaultNodeData = {propName: 'property', selector: 'selector', propType: _user$project$Model_NodeData$RawText, attributeName: 'attribute name', isArray: false};

var _user$project$Model_Node$createDefaultNodeView = {expanded: true};
var _user$project$Model_Node$nodeChildList = function (node) {
	var _p0 = node.children;
	return _p0._0;
};
var _user$project$Model_Node$hasNoChildren = function (node) {
	return _elm_lang$core$List$isEmpty(
		_user$project$Model_Node$nodeChildList(node));
};
var _user$project$Model_Node$hasChildren = function (node) {
	return !_user$project$Model_Node$hasNoChildren(node);
};
var _user$project$Model_Node$findNodes = F2(
	function (node, matchFunction) {
		return matchFunction(node) ? {
			...
			A2(
				_elm_lang$core$List$map,
				function (childNode) {
					return A2(_user$project$Model_Node$findNodes, childNode, matchFunction);
				},
				_user$project$Model_Node$nodeChildList(node)));
	});
var _user$project$Model_Node$findNodeById = F2(
	function (nodeId, rootNode) {
		return _elm_lang$core$List$head(
			A2(
				_user$project$Model_Node$findNodes,
				rootNode,
				function (n) {
					return _elm_lang$core$Native_Utils.eq(n.id, nodeId);
				}));
	});
var _user$project$Model_Node$getNodeData = F2(
	function (nodeId, rootNode) {
		var _p1 = A2(_user$project$Model_Node$findNodeById, nodeId, rootNode);
		if (_p1.ctor === 'Just') {
			return _elm_lang$core$Maybe$Just(_p1._0.data);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Model_Node$isChildNode = F2(
	function (nodeId, node) {
		return !_elm_lang$core$List$isEmpty(
			A2(
				_elm_lang$core$List$filter,
				function (nd) {
					return _elm_lang$core$Native_Utils.eq(nd.id, nodeId);
				},
				_user$project$Model_Node$nodeChildList(node)));
	});
var _user$project$Model_Node$NodeView = function (a) {
	return {expanded: a};
};
var _user$project$Model_Node$Node = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, data: c, view: d, children: e};
	});
var _user$project$Model_Node$Children = function (a) {
	return {ctor: 'Children', _0: a};
};
var _user$project$Model_Node$appendChildren = F2(
	function (target, newNodes) {
		return _elm_lang$core$Native_Utils.update(
			target,
			{
				children: _user$project$Model_Node$Children(
					A2(
						_elm_lang$core$List$append,
						_user$project$Model_Node$nodeChildList(target),
						newNodes)),
				view: {expanded: true}
			});
	});
var _user$project$Model_Node$appendChild = F2(
	function (target, newNode) {
		return A2(
			_user$project$Model_Node$appendChildren,
			target,
			{
				ctor: '::',
				_0: newNode,
...
var _user$project$Model_Node$appendChildById = F3(
	function (nodeId, nodeToAppend, rootNode) {
		return _elm_lang$core$Native_Utils.eq(rootNode.id, nodeId) ? A2(_user$project$Model_Node$appendChild, rootNode, nodeToAppend) : _elm_lang$core$Native_Utils.update(
			rootNode,
			{
				children: _user$project$Model_Node$Children(
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$Model_Node$appendChildById, nodeId, nodeToAppend),
						_user$project$Model_Node$nodeChildList(rootNode)))
			});
	});
var _user$project$Model_Node$updateNodeData = F3(
	function (nodeId, nodeData, rootNode) {
		return _elm_lang$core$Native_Utils.eq(rootNode.id, nodeId) ? _elm_lang$core$Native_Utils.update(
			rootNode,
			{data: nodeData}) : _elm_lang$core$Native_Utils.update(
			rootNode,
			{
				children: _user$project$Model_Node$Children(
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$Model_Node$updateNodeData, nodeId, nodeData),
						_user$project$Model_Node$nodeChildList(rootNode)))
			});
	});
var _user$project$Model_Node$updateNodeView = F3(
		...
		return _elm_lang$core$Native_Utils.eq(rootNode.id, nodeId) ? _elm_lang$core$Native_Utils.update(
			...
			rootNode,
			{
				children: _user$project$Model_Node$Children(
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$Model_Node$updateNodeView, nodeId, nodeView),
						_user$project$Model_Node$nodeChildList(rootNode)))
			});
	});
var _user$project$Model_Node$collapseAllNodes = F2(
		...
		return _elm_lang$core$Native_Utils.update(
			rootNode,
			{
				...
				children: _user$project$Model_Node$Children(
					A2(
						_elm_lang$core$List$map,
						_user$project$Model_Node$collapseAllNodes(collapse),
						_user$project$Model_Node$nodeChildList(rootNode)))
			});
	});
var _user$project$Model_Node$deleteNodeById = F2(
	function (nodeId, parentNode) {
		return (!A2(_user$project$Model_Node$isChildNode, nodeId, parentNode)) ? _elm_lang$core$Native_Utils.update(
			parentNode,
			{
				children: _user$project$Model_Node$Children(
					A2(
						_elm_lang$core$List$map,
						_user$project$Model_Node$deleteNodeById(nodeId),
						_user$project$Model_Node$nodeChildList(parentNode)))
			}) : _elm_lang$core$Native_Utils.update(
			parentNode,
			{
				children: _user$project$Model_Node$Children(
					A2(
						_elm_lang$core$List$filter,
						function (node) {
							return !_elm_lang$core$Native_Utils.eq(node.id, nodeId);
						},
						_user$project$Model_Node$nodeChildList(parentNode)))
			});
	});

var _user$project$Encode$propertyTypeEncoder = function (propType) {
	var _p0 = propType;
	switch (_p0.ctor) {
		case 'RawText':
			return _elm_lang$core$Json_Encode$string('raw_text');
		case 'HtmlText':
			return _elm_lang$core$Json_Encode$string('html_text');
		case 'AttributeValue':
			return _elm_lang$core$Json_Encode$string('attribute_value');
		default:
			return _elm_lang$core$Json_Encode$string('object');
	}
};
var _user$project$Encode$nodeDataEncoder = function (nodeData) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'propName',
				_1: _elm_lang$core$Json_Encode$string(nodeData.propName)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'selector',
					_1: _elm_lang$core$Json_Encode$string(nodeData.selector)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'propType',
						_1: _user$project$Encode$propertyTypeEncoder(nodeData.propType)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'attributeName',
							_1: _elm_lang$core$Json_Encode$string(nodeData.attributeName)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'isArray',
								_1: _elm_lang$core$Json_Encode$bool(nodeData.isArray)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Encode$nodeEncoder = function (node) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(node.id)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'data',
					_1: _user$project$Encode$nodeDataEncoder(node.data)
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$list(
							A2(
								_elm_lang$core$List$map,
								function (c) {
									return _user$project$Encode$nodeEncoder(c);
								},
								_user$project$Model_Node$nodeChildList(node)))
					},
					_1: {ctor: '[]'}
...
var _user$project$Encode$encodeTree = function (rootNode) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		2,
		_user$project$Encode$nodeEncoder(rootNode));
};

var _user$project$Model_Tree$rootNodeLabel = function (nodeLabel) {
	var _p0 = nodeLabel;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Model_Tree$createRootNode = function (nodeLabel) {
	return A5(
		_user$project$Model_Node$Node,
		'root',
		_user$project$Model_Tree$rootNodeLabel(nodeLabel),
		_user$project$Model_NodeData$createDefaultNodeData,
		_user$project$Model_Node$createDefaultNodeView,
		_user$project$Model_Node$Children(
			{ctor: '[]'}));
};
var _user$project$Model_Tree$isRoot = function (node) {
	return _elm_lang$core$Native_Utils.eq(node.id, 'root');
};
...
var _user$project$Model$createSampleTree = A2(
	_user$project$Model_Node$appendChildren,
	_user$project$Model_Tree$createRootNode(
		_elm_lang$core$Maybe$Just('root')),
	{
		ctor: '::',
		_0: A5(
			_user$project$Model_Node$Node,
...
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {tree: a, selectedNodeId: b, maxNodeId: c, state: d, editedNodeData: e, validationErrors: f};
	});
var _user$project$Model$CreateNode = {ctor: 'CreateNode'};
var _user$project$Model$UpdateNode = {ctor: 'UpdateNode'};
var _user$project$Model$Read = {ctor: 'Read'};
var _user$project$Model$initialModel = {
	tree: _user$project$Model$createSampleTree,
	selectedNodeId: _elm_lang$core$Maybe$Nothing,
	maxNodeId: 5,
	state: _user$project$Model$Read,
	editedNodeData: _user$project$Model_NodeData$createDefaultNodeData,
	validationErrors: {ctor: '[]'}
};

var _user$project$Message$EncodeModel = {ctor: 'EncodeModel'};
var _user$project$Message$SendData = {ctor: 'SendData'};
...
var _user$project$Message$CancelEdit = {ctor: 'CancelEdit'};
var _user$project$Message$SaveEdit = {ctor: 'SaveEdit'};
var _user$project$Message$EditNode = function (a) {
	return {ctor: 'EditNode', _0: a};
};
var _user$project$Message$DeleteSelectedNode = {ctor: 'DeleteSelectedNode'};
var _user$project$Message$AddChildNodeToSelectedNode = {ctor: 'AddChildNodeToSelectedNode'};
var _user$project$Message$DeselectAllNodes = {ctor: 'DeselectAllNodes'};
var _user$project$Message$NodeSelection = function (a) {
	return {ctor: 'NodeSelection', _0: a};
};
var _user$project$Message$NoOp = {ctor: 'NoOp'};

var _user$project$View_Toolbar$renderToolbar = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$disabled(
								(!_elm_lang$core$Native_Utils.eq(model.state, _user$project$Model$Read)) || _elm_lang$core$Native_Utils.eq(model.selectedNodeId, _elm_lang$core$Maybe$Nothing)),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('add child node'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$disabled(
										(!_elm_lang$core$Native_Utils.eq(model.state, _user$project$Model$Read)) || (_elm_lang$core$Native_Utils.eq(model.selectedNodeId, _elm_lang$core$Maybe$Nothing) || _elm_lang$core$Native_Utils.eq(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Delete Node'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
									...
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$disabled(
													!_elm_lang$core$Native_Utils.eq(model.state, _user$project$Model$Read)),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Message$SendData),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('btn btn-light'),
													_1: {ctor: '[]'}
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Message$EncodeModel),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('btn btn-light'),
														_1: {ctor: '[]'}
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Encode'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$View_NodeForm$renderValidationErrors = function (errors) {
	return _elm_lang$core$List$isEmpty(errors) ? A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('It seems that one or more entered values are not valid : '),
			_1: {
				ctor: '::',
				_0: A2(
...
var _user$project$View_NodeForm$renderRootNodeEditForm = F2(
	function (nodeData, validationErrors) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _user$project$View_NodeForm$renderValidationErrors(validationErrors),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
...
var _user$project$View_NodeForm$renderOptionalAttributeNameFormGroup = function (nodeData) {
	return _elm_lang$core$Native_Utils.eq(nodeData.propType, _user$project$Model_NodeData$AttributeValue) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('form-group'),
...
var _user$project$View_NodeForm$renderPropertyTypeOption = F2(
	function (currentValue, _p0) {
		var _p1 = _p0;
		var _p2 = _p1._0;
		return A2(
			_elm_lang$html$Html$option,
			{
				...
				_0: _elm_lang$html$Html_Attributes$value(
					_user$project$Model_NodeData$propertyTypeToValue(_p2)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(currentValue, _p2)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$View_NodeForm$renderRegularNodeEditForm = F2(
	function (nodeData, validationErrors) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
					...
					_1: {
						...
						_1: {
							...
							_1: {
									...
									},
									{
										...
										_1: {
											...
											_0: A2(
														...
														_0: _elm_lang$html$Html_Events$onInput(
															function (selection) {
																return _user$project$Message$ChangePropertyTypeSelection(
																	_user$project$Model_NodeData$valueToPropertyType(selection));
															}),
														_1: {ctor: '[]'}
													}
												},
												A2(
													_elm_lang$core$List$map,
													_user$project$View_NodeForm$renderPropertyTypeOption(nodeData.propType),
													_user$project$Model_NodeData$propertyTypeOptions)),
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									ctor: '::',
									_0: _user$project$View_NodeForm$renderOptionalAttributeNameFormGroup(nodeData),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
...
var _user$project$View_NodeForm$renderNodeEditForm = F4(
	function (state, node, nodeData, validationErrors) {
		return (_user$project$Model_Tree$isRoot(node) && _elm_lang$core$Native_Utils.eq(state, _user$project$Model$UpdateNode)) ? A2(_user$project$View_NodeForm$renderRootNodeEditForm, nodeData, validationErrors) : A2(_user$project$View_NodeForm$renderRegularNodeEditForm, nodeData, validationErrors);
	});

var _user$project$Validation$validateRootNode = function (node) {
	return _elm_lang$core$Maybe$Nothing;
};
var _user$project$Validation$unexpectedObjectDefinition = function (node) {
	return (!_elm_lang$core$Native_Utils.eq(node.data.propType, _user$project$Model_NodeData$Object)) && (_user$project$Model_Node$hasChildren(node) && (!_elm_lang$core$Native_Utils.eq(node.id, '0')));
};
var _user$project$Validation$missingObjectDefinition = function (node) {
	return _elm_lang$core$Native_Utils.eq(node.data.propType, _user$project$Model_NodeData$Object) && ((!_user$project$Model_Node$hasChildren(node)) && (!_elm_lang$core$Native_Utils.eq(node.id, '0')));
};
var _user$project$Validation$validateRegularNode = function (node) {
	return _user$project$Validation$missingObjectDefinition(node) ? _elm_lang$core$Maybe$Just('The type of this property is Object, \n        but you have not define any property for this object, so its not consistent.\n        You can add child node or change the type of this property.\n        ') : (_user$project$Validation$unexpectedObjectDefinition(node) ? _elm_lang$core$Maybe$Just('The type of this property is not Object, however it has some children properties. \n        You should change the type of Property to Object or delete the child node.\n        ') : _elm_lang$core$Maybe$Nothing);
};
var _user$project$Validation$validateNode = function (node) {
	return _user$project$Model_Tree$isRoot(node) ? _user$project$Validation$validateRootNode(node) : _user$project$Validation$validateRegularNode(node);
};
...
var _user$project$Validation$propertyNameIsNotEmpty = function (data) {
	return _user$project$Validation$isNonEmptyTrimmedString(data.propName) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just('Missing Property Name');
};
var _user$project$Validation$selectorIsNotEmpty = function (data) {
	return _user$project$Validation$isNonEmptyTrimmedString(data.selector) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just('Missing selector');
};
var _user$project$Validation$validateNodeForm = function (data) {
	return A2(
		_elm_lang$core$List$filter,
		function (errorMsg) {
			return !_elm_lang$core$String$isEmpty(errorMsg);
		},
		A2(
			_elm_lang$core$List$map,
			function (validate) {
				var _p0 = validate(data);
				if (_p0.ctor === 'Just') {
					return _p0._0;
				} else {
					return '';
			...
			{
				ctor: '::',
				_0: _user$project$Validation$propertyNameIsNotEmpty,
				_1: {
					ctor: '::',
					_0: _user$project$Validation$selectorIsNotEmpty,
					_1: {ctor: '[]'}
				}
			}));
};
var _user$project$Validation$objectProperty = function (node) {
	return _elm_lang$core$Native_Utils.eq(node.data.propType, _user$project$Model_NodeData$Object) && (!_user$project$Model_Node$hasChildren(node));
};

var _user$project$View_NodeView$renderRootNodeView = function (node) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$View_NodeView$renderWarningMissingChild = function (node) {
	var _p0 = _user$project$Validation$validateNode(node);
	if (_p0.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _user$project$View_NodeView$renderNodeView = function (node) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$View_NodeView$renderWarningMissingChild(node),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$table,
									...
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_1: {
														...
														_1: {
															...
															_0: A2(
																...
																{ctor: '[]'},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		_user$project$Model_NodeData$propertyTypeToText(node.data.propType)),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Native_Utils.eq(node.data.propType, _user$project$Model_NodeData$AttributeValue) ? A2(
														_elm_lang$html$Html$tr,
														{ctor: '[]'},
														{
															ctor: '::',
...
var _user$project$View_NodeView$renderSelectedNodeView = function (node) {
	return _user$project$Model_Tree$isRoot(node) ? _user$project$View_NodeView$renderRootNodeView(node) : _user$project$View_NodeView$renderNodeView(node);
};

var _user$project$View_Tree$renderTreeInfo = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$View_Tree$renderNodeLabel = function (node) {
	return A2(
...
var _user$project$View_Tree$renderNodeToggler = function (node) {
	var buttonText = _user$project$Model_Node$hasChildren(node) ? (_elm_lang$core$Native_Utils.eq(node.view.expanded, true) ? '-' : '+') : '';
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Message$ToggleNodeView(node)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$View_Tree$renderNode = F2(
	function (model, node) {
		var hint = _elm_lang$core$Native_Utils.eq(
			_user$project$Validation$validateNode(node),
			_elm_lang$core$Maybe$Nothing) ? _elm_lang$html$Html$text('') : A2(
			_elm_lang$html$Html$span,
			{ctor: '[]'},
			{
				ctor: '::',
		...
		var childrenClassname = _user$project$Model_Node$hasChildren(node) ? 'has-children' : '';
		var expandedClassname = _user$project$Model_Node$hasChildren(node) ? (_elm_lang$core$Native_Utils.eq(node.view.expanded, true) ? 'expanded-node' : 'collapsed-node') : ' ';
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('node-group'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Message$NodeSelection(node)),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _user$project$View_Tree$renderNodeToggler(node),
						_1: {
							ctor: '::',
							_0: _user$project$View_Tree$renderNodeLabel(node),
							_1: {
								ctor: '::',
								_0: hint,
								_1: {ctor: '[]'}
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$View_Tree$renderChildren, model, node.children),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$View_Tree$renderChildren = F2(
	function (model, _p0) {
		var _p1 = _p0;
		var _p2 = _p1._0;
		return _elm_lang$core$Native_Utils.eq(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$View_Tree$renderNode(model),
				_p2));
	});
var _user$project$View_Tree$renderTreeView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$View_Tree$renderNode, model, model.tree),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$View$renderRightPanel = function (model) {
	...
	if (_p0.ctor === 'Just') {
		var _p1 = A2(_user$project$Model_Node$findNodeById, _p0._0, model.tree);
		if (_p1.ctor === 'Just') {
			var _p2 = _p1._0;
			return _elm_lang$core$Native_Utils.eq(model.state, _user$project$Model$Read) ? _user$project$View_NodeView$renderSelectedNodeView(_p2) : A4(_user$project$View_NodeForm$renderNodeEditForm, model.state, _p2, model.editedNodeData, model.validationErrors);
		} else {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$View_Toolbar$renderToolbar(model),
					_1: {
						ctor: '::',
						_0: _user$project$View_Tree$renderTreeView(model),
						_1: {
							ctor: '::',
							_0: _user$project$View_Tree$renderTreeInfo(model),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$Update_Save$createNodeAndAppend = F2(
	function (model, parentNodeId) {
		var validationErrors = _user$project$Validation$validateNodeForm(model.editedNodeData);
		var isValid = _elm_lang$core$List$isEmpty(validationErrors);
		var updatedModel = function () {
			if (isValid) {
				var newNode = A5(
					_user$project$Model_Node$Node,
					_user$project$Model$createNodeId(model),
					model.editedNodeData.propName,
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						tree: A3(_user$project$Model_Node$appendChildById, parentNodeId, newNode, model.tree),
...
var _user$project$Update_Save$updateExistingNode = F2(
	function (model, selectedNodeId) {
		var validationErrors = _user$project$Validation$validateNodeForm(model.editedNodeData);
		var isValid = _elm_lang$core$List$isEmpty(validationErrors);
		var updatedTree = isValid ? A3(_user$project$Model_Node$updateNodeData, selectedNodeId, model.editedNodeData, model.tree) : model.tree;
		var updatedState = isValid ? _user$project$Model$Read : model.state;
		return _elm_lang$core$Native_Utils.update(
			model,
			{tree: updatedTree, validationErrors: validationErrors, state: updatedState});
	});

var _user$project$Port$sendData = _elm_lang$core$Native_Platform.outgoingPort(
	'sendData',
	function (v) {
		return v;
	});
		...
		switch (_p0.ctor) {
			...
			case 'EncodeModel':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Port$sendData(
						_user$project$Encode$encodeTree(model.tree))
				};
			case 'SendData':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Port$sendData('hello')
				};
			case 'EditNode':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{editedNodeData: _p0._0.data, state: _user$project$Model$UpdateNode}),
			...
			case 'SaveEdit':
				var _p1 = model.selectedNodeId;
				if (_p1.ctor === 'Just') {
					var _p2 = _p1._0;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.eq(model.state, _user$project$Model$CreateNode) ? A2(_user$project$Update_Save$createNodeAndAppend, model, _p2) : A2(_user$project$Update_Save$updateExistingNode, model, _p2),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'NodeSelection':
				return _elm_lang$core$Native_Utils.eq(model.state, _user$project$Model$Read) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedNodeId: _elm_lang$core$Maybe$Just(_p0._0.id)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'AddChildNodeToSelectedNode':
				...
				if (_p3.ctor === 'Just') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{editedNodeData: _user$project$Model_NodeData$createDefaultNodeData, state: _user$project$Model$CreateNode}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				...
				if (_p4.ctor === 'Just') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tree: A2(_user$project$Model_Node$deleteNodeById, _p4._0, model.tree),
								selectedNodeId: _elm_lang$core$Maybe$Nothing
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'ToggleNodeView':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tree: A3(_user$project$Model_Node$updateNodeView, _p5.id, _p5.view, model.tree)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tree: A2(_user$project$Model_Node$collapseAllNodes, _p0._0, model.tree)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Message.Msg","aliases":{"Model.NodeData.NodeData":{"type":"{ propName : String , selector : String , propType : Model.NodeData.PropertyType , attributeName : String , isArray : Bool }","args":[]},"Model.Node.Node":{"type":"{ id : Model.Node.NodeId , name : String , data : Model.NodeData.NodeData , view : Model.Node.NodeView , children : Model.Node.Children }","args":[]},"Model.Node.NodeId":{"type":"String","args":[]},"Model.Node.NodeView":{"type":"{ expanded : Bool }","args":[]}},"unions":{"Model.Node.Children":{"tags":{"Children":["List Model.Node.Node"]},"args":[]},"Message.Msg":{"tags":{"SendData":[],"ToggleNodeView":["Model.Node.Node"],"SaveEdit":[],"NodeSelection":["Model.Node.Node"],"DeleteSelectedNode":[],"InputSelector":["String"],"DeselectAllNodes":[],"InputPropertyName":["String"],"NoOp":[],"AddChildNodeToSelectedNode":[],"ToggleIsArray":[],"EncodeModel":[],"CollapseAllNodes":["Bool"],"EditNode":["Model.Node.Node"],"CancelEdit":[],"InputAttributeName":["String"],"ChangePropertyTypeSelection":["Maybe.Maybe Model.NodeData.PropertyType"]},"args":[]},"Model.NodeData.PropertyType":{"tags":{"Object":[],"HtmlText":[],"AttributeValue":[],"RawText":[]},"args":[]},"Maybe.Maybe":{"tags":{"Nothing":[],"Just":["a"]},"args":["a"]}}},"versions":{"elm":"0.18.0"}});
}
