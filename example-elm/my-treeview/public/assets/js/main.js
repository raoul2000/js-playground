...
var _user$project$Model$nodeChildList = function (node) {
	var _p0 = node.children;
	return _p0._0;
};
var _user$project$Model$findNodes = F2(
	function (node, matchFunction) {
		return matchFunction(node) ? {
			...
			A2(
				_elm_lang$core$List$map,
				function (childNode) {
					return A2(_user$project$Model$findNodes, childNode, matchFunction);
				},
				_user$project$Model$nodeChildList(node)));
	});
var _user$project$Model$findNodeById = F2(
	function (nodeId, rootNode) {
		return _elm_lang$core$List$head(
			A2(
				_user$project$Model$findNodes,
				rootNode,
				function (n) {
					return _elm_lang$core$Native_Utils.eq(n.id, nodeId);
				}));
	});
var _user$project$Model$getNodeData = F2(
	function (nodeId, rootNode) {
		var _p1 = A2(_user$project$Model$findNodeById, nodeId, rootNode);
		if (_p1.ctor === 'Just') {
...
var _user$project$Model$hasNoChildren = function (node) {
	return _elm_lang$core$List$isEmpty(
		_user$project$Model$nodeChildList(node));
};
var _user$project$Model$hasChildren = function (node) {
	return !_user$project$Model$hasNoChildren(node);
};
var _user$project$Model$isChildNode = F2(
...
var _user$project$Model$appendChild = F2(
		...
		return _elm_lang$core$Native_Utils.update(
			target,
			{
				children: _user$project$Model$Children(
					A2(
						_elm_lang$core$List$append,
						_user$project$Model$nodeChildList(target),
						{
							ctor: '::',
							_0: newNode,
							_1: {ctor: '[]'}
...
var _user$project$Model$appendChildById = F3(
	function (nodeId, nodeToAppend, rootNode) {
		return _elm_lang$core$Native_Utils.eq(rootNode.id, nodeId) ? A2(_user$project$Model$appendChild, rootNode, nodeToAppend) : _elm_lang$core$Native_Utils.update(
			rootNode,
			{
				children: _user$project$Model$Children(
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$Model$appendChildById, nodeId, nodeToAppend),
						_user$project$Model$nodeChildList(rootNode)))
			});
	});
var _user$project$Model$updateNodeData = F3(
		...
		return _elm_lang$core$Native_Utils.eq(rootNode.id, nodeId) ? _elm_lang$core$Native_Utils.update(
			...
			rootNode,
			{
				children: _user$project$Model$Children(
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$Model$updateNodeData, nodeId, nodeData),
						_user$project$Model$nodeChildList(rootNode)))
			});
	});
var _user$project$Model$updateNodeView = F3(
		...
		return _elm_lang$core$Native_Utils.eq(rootNode.id, nodeId) ? _elm_lang$core$Native_Utils.update(
			...
			rootNode,
			{
				children: _user$project$Model$Children(
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$Model$updateNodeView, nodeId, nodeView),
						_user$project$Model$nodeChildList(rootNode)))
			});
	});
		...
		return (!A2(_user$project$Model$isChildNode, nodeId, parentNode)) ? _elm_lang$core$Native_Utils.update(
			parentNode,
			{
				children: _user$project$Model$Children(
					A2(
						_elm_lang$core$List$map,
						_user$project$Model$deleteNodeById(nodeId),
						_user$project$Model$nodeChildList(parentNode)))
			}) : _elm_lang$core$Native_Utils.update(
			parentNode,
			{
				children: _user$project$Model$Children(
...
var _user$project$View$renderTreeInfo = function (model) {
		...
		if (_p2.ctor === 'Just') {
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					' viewMode = ',
					_elm_lang$core$Basics$toString(model.viewMode)));
		} else {
			return 'no selection';
		}
	}();
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(txtSelectedNodeId),
			_1: {ctor: '[]'}
		});
};
	...
	function (model, node) {
		...
		return A2(
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$View$renderChildren, model, node.children),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _user$project$View$renderTreeView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$View$renderNode, model, model.tree),
			_1: {ctor: '[]'}
		});
};
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'EditNode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{viewMode: false, editedNodeData: _p0._0.data}),
				...
				if (_p1.ctor === 'Just') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tree: A3(_user$project$Model$updateNodeData, _p1._0, model.editedNodeData, model.tree),
								viewMode: true
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'AddChildNodeToSelectedNode':
				var _p2 = model.selectedNodeId;
				if (_p2.ctor === 'Just') {
					var newNode = _user$project$Model$createNode(model);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tree: A3(_user$project$Model$appendChildById, _p2._0, newNode, model.tree),
								selectedNodeId: _elm_lang$core$Maybe$Just(newNode.id),
				...
				if (_p3.ctor === 'Just') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tree: A2(_user$project$Model$deleteNodeById, _p3._0, model.tree),
								selectedNodeId: _elm_lang$core$Maybe$Nothing
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {tree: _user$project$Model$createSampleTree, selectedNodeId: _elm_lang$core$Maybe$Nothing, maxNodeId: 5, viewMode: true, editedNodeData: _user$project$Model$createDefaultNodeData},
	_1: _elm_lang$core$Platform_Cmd$none
};
